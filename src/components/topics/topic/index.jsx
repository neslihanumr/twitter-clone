        ...
        >
          <div className="text-[0.813rem] text-[#71767b] leading-4">{item.title}</div>
            ...
            <Popover className="absolute top-1.5 right-2">
                ...
                <Popover.Panel className="w-[24rem] rounded-xl grid absolute overflow-hidden top-2 right-0 bg-black shadow-box z-[2]">
                    <button type="button"
                            className="hover:bg-white/[0.03] transition-colors text-left py-3 px-4 flex items-center gap-3 text-[15px] leading-5 font-bold text-[#e7e9ea]">
                        <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                            <path
                                fill="currentColor"
